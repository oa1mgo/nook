...
private let logger = Logger(subsystem: "com.celestial.Nook", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.celestial.Nook.agentfilewatcher", qos: .userInitiated)
